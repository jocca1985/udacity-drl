...
def cem(n_iterations=500, max_t=1001, gamma=1.0, print_every=1, pop_size=100, elite_frac=0.1, sigma=0.1):
    ...
    for i_iteration in range(1, n_iterations+1):
        ...
        torch.save(agent.state_dict(), 'checkpoint_cross_entropy.pth')
